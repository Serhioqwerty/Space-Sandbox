...
private:
	...
	float mass;
public:
	Center(Vector2 pos, float radius, Color color, float mass) {
		this->mass = mass;
		this->pos = pos;
		this->color = color;
		this->radius = radius;
...
public:
	Orbit* orbit;
	Planet(Vector2 position, float radius, float t, float m) : orbit(nullptr) {
...
private:
	...
	float angle = 0;
public:
	Orbit(float radius, float mass, float distance, Color color) : planet(nullptr) {}
...
int CreatePlanet(Vector2 pos, float radius, float mass, float temperature) {
	Planets.emplace_back(pos, radius, temperature, mass);
...
int main() {
	...
	int second_planet = CreatePlanet({ 1100000, 200 }, 1000000, 500000000, 4000);
	int Universe = CreatePlanet({ 110000000, 200 }, 100000000, 50000000000, 12000);
	int Multi_Universe = CreatePlanet({ 10e9, 10e9 }, 1000000000, 5000000000000, 12000);
